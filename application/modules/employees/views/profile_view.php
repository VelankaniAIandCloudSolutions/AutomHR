						...
						<div class="row">
							<div class="col-md-5">
								<div class="profile-info-left">
									...
									<div class="staff-id">Employee ID : <?php if($employee_details['employee_id']) { echo $employee_details['emp_code']; } else { echo ''; } ?></div>
										...
										if(!empty($all_file_attachments)){
											foreach($all_file_attachments as $attachment){ 
												...
												<tr>
													...
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<a href="<?php echo base_url().'employees/delete_document/'.$attachment['id'];?>" onclick="return confirm('Are you want to delete?')">Delete</a></td>
												</tr>
											<?php 	
												$re++;
											}
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="post" action="<?php echo base_url(); ?>employees/edit_document/<?php echo $employee_details['user_id']; ?>" enctype="multipart/form-data">
									...
									<div class="form-group namediv">
										<label>Name <span class="text-danger">*</span></label>
										<input class="form-control" type="text" name = "document_name[]" id="edit_document_name" required >
									</div>
									<div class="form-group">
						...
						<input type="hidden" value="<?php echo $user_type[0]->r_id;?>" name="user_type">
												...
												<div class="form-group">
													<label class=""><?=lang('location')?> </label>
														...
														<select class="form-control" style="width:100%;" name="location" id="location">
															...
															<option value="VEPL" <?php echo ($employee_details['location1']=='VEPL')?'selected':'';?>>VEPL</option>
										...
										<div class="col-sm-6">
											...
											<div class="form-group">
												...
												<input class="form-control datepicker1" readonly size="16" type="text" value="<?php echo (!empty($employee_details['emp_gjd']))?date('Y-m-d',strtotime($employee_details['emp_gjd'])):'';?>"  name="emp_gjd" id="emp_gjd" data-date-format="yyyy-mm-dd"  >
											</div>
...
<script type="text/javascript">
	...
	function edit_document(a){
		$('#document_id').val(a);
		$.ajax({url: "<?php echo base_url(); ?>employees/get_document/"+a, success: function(result){
...
<style>
	...
	.add-doc:active,.add-doc:focus{
		color:#007bff;
		text-decoration:underline !important;
	}
	.add-doc:hover,.del-doc:hover{
		color:red !important
	}
	.del-doc {
		margin-right: 10%;
