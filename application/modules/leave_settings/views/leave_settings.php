	...
	<div class="row">
		...
		<?php /*
			...
			*/?>
			...
			$extra_leave_types = $this->db->group_by('leave_type_id')->order_by('leave_id', 'ASC')->get_where('dgt_common_leave_types',array('leave_type_id!='=>47,'leave_type_id!='=>9,'status'=>1))->result_array(); 
...
function accrual_leaves(branch_id)
{
	...
	if(leave_day == '')
	{
		toastr.error('Days Field is Required');
		return false;
	}
