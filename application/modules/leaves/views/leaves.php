...
<div class="content">
	...
	<?php $leav_types =  $this->db->get_where('common_leave_types',array('status'=>'0'))->result_array();  ?> 
				...
				<div class="form-group">
					...
					<div class="col-lg-4">
						<select class="select2-option form-control" onchange="Getholidays();" style="width:100%;" id="req_leave_type" name="req_leave_type"> 
							...
							$all_leave_types = $this->db->get_where('common_leave_types',array('status'=>'0','branch_id'=>$this->session->userdata('branch_id')))->result_array();
