									...
									<tbody>
										...
										<tr>
											...
											<td  class="text-center">
												<a href="#" class="like-icon m-r-10"><i class="fa fa-file-archive-o" title="Archive" aria-hidden="true" onclick="app_archive('1','<?=$ipv['caid']?>')"></i></a>
											</td>
											<td>
												<div class="tabbable">
								...
								<table class="table custom-table datatable table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												<a href="#" class="like-icon m-r-10"><i class="fa fa-file-archive-o" title="Archive" aria-hidden="true" onclick="app_archive('2','<?=$ipv['caid']?>')"></i></a>
												<a href="#" onclick="send_Appmails('<?=$rv['caid']?>')" class="btn btn-info">Send Offer</a>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												...
												<a href="#" class="like-icon text-danger" data-toggle="modal" data-target="#offer_decline"  onclick="set_appval('<?=$ipv['caid']?>')"><i class="fa fa-thumbs-o-down" title='Decline' aria-hidden="true"></i></a>
												<a href="#" class="like-icon m-r-10"><i class="fa fa-file-archive-o" title="Archive" aria-hidden="true" onclick="app_archive('3','<?=$ipv['caid']?>')"></i></a>
												<a href="#" class="like-icon  text-success m-r-10"><i class="fa fa-check" title="Accept" aria-hidden="true" onclick="app_accept('<?=$ipv['caid']?>')"></i></a>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												<!-- <a href="#" class="like-icon text-success m-r-10"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a> -->
												<a href="#" class="like-icon text-danger" data-toggle="modal" data-target="#offer_decline"  onclick="set_appval('<?=$ipv['caid']?>')"><i class="fa fa-thumbs-o-down" title='Decline' aria-hidden="true"></i></a>
												<a href="#" class="like-icon m-r-10"><i class="fa fa-file-archive-o" title="Archive" aria-hidden="true" onclick="app_archive('4','<?=$ipv['caid']?>')"></i></a>
												<a href="<?php echo base_url()?>offers/onboarding/<?=$ipv['caid']?>" title="Onboarding" aria-hidden="true" class="m-r-10">Onboarding</a>
											</td>
											<td>
												<div class="tabbable">
													<ul class="nav navbar-nav wizard m-b-0">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												...
												<a href="#" class="like-icon m-r-10"><i class="fa fa-file-archive-o" title="Archive" aria-hidden="true" onclick="app_archive('5','<?=$ipv['caid']?>')"></i></a>
											</td>
											<td>
												<div class="tabbable">
													<ul class="nav navbar-nav wizard m-b-0">
								...
								<table class="table custom-table datatable table-bordered">
									...
									<tbody><?php 
										...
										<tr>
											...
											<td class="text-center">
												<a href="#" class="like-icon text-success m-r-10"><i class="fa fa-thumbs-o-up" title='Accept' aria-hidden="true" onclick="app_retrieve('<?=$ipv['caid']?>')"></i></a>
