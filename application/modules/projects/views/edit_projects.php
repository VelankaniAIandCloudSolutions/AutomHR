						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									...
									<select class="select2-option form-control"   style="width:260px" name="assign_lead" id="assign_lead"> 
										<optgroup label="Staff">
											...
											foreach ($users as $user1){
												...
												?>
												<option value="<?=$user1['user_id'];?>"  <?php if($user1['user_id']==$project->assign_lead){ echo 'selected';}?>>
													<?=$user1['fullname'];?>
												</option>
											<?php  }
											}
