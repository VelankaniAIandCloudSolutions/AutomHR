			...
			foreach($users as $user1){
				...
				if(!empty($leave_types)){
					foreach($leave_types as $leave_type1){
						...
						if($leave_type1['leave_type_id'] == 9){
							$minus_leave = 0;
				...
				$return_data['data'][$i]['total']['available'] = $total_available;
