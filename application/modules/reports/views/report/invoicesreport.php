...
<div class="content">
          ...
          <div class="panel-heading">
            ...
            <?php if($this->uri->segment(3)){ ?>
              <a href="<?=base_url()?>reports/invoicespdf/<?=strtotime($start_date)?>/<?=strtotime($end_date)?>/<?=$report_by?>" class="btn btn-primary pull-right"><i class="fa fa-file-pdf-o"></i><?=lang('pdf')?>
              </a>
            <?php } ?>
  ...
  <div class="criteria-band">
    ...
    <?php
        ...
        <div class="col-md-2">
          ...
          <select <?=$dis?> class="form-control" name="branch_id"><!---->
