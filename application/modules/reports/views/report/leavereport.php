                ...
                ?>
                  { data: "<?php echo str_replace(' ', '_', $leave_type1['leave_type']);?>",
                    "render": function (data, type, row, meta) {
                        return '<div class="col-md-12 text-center"><div class="col-md-4 text-center">'+data.available + '</div><div class="col-md-4 text-center">'+data.booked+'</div><div class="col-md-4 text-center">'+data.total+'</div></div>';
                    }
