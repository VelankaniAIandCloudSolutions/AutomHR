							...
							<div class="modal-body">
								<form action="#"  id="add_resignations" method="post" enctype="multipart/form-data" data-parsley-validate novalidate > 
									...
									<div class="form-group">
										...
										<select onchange="get_employee_byentity();" class="form-control" style="width:100%;"  name="branch_id" id="add_branch" >
									...
									<div class="form-group">
										...
										<select class="select2-option1" style="width:100%;" name="employee" id="employee_id" > 
