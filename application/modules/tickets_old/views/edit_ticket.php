           ...
           ?>
			 ...
			 <div class="form-group">
				...
				<div class="col-lg-6">
					...
					<?php 
					$departments = App::get_by_where('departments',array('deptid >'=>'0','branch_id'=>$this->session->userdata('branch_id')));
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					...
					<?php foreach (User::all_users() as $user): 
						$branch_id = User::profile_info($user->id)->branch_id;
        ...
        $('#clear-files').click(function(){
            $('#file_container').html(
                "<div class='form-group'>" +
                    ...
                    "<div class='col-lg-6'>" +
                    "<label class='btn btn-default btn-choose'>Choose File</label><input class='form-control' type='file' name='ticketfiles[]'>" +
                    "</div></div>"
            );
        });
